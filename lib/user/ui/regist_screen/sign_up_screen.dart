...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void _registerUser() async {
    if (_formKey.currentState!.validate()) {
      ...
      // TODO: Thực hiện đăng ký với Firebase Auth
      // Sau khi đăng ký thành công, lưu thông tin user vào Firestore:
      await FirebaseFirestore.instance.collection('user').add({
        'Email': email,
        'Phone_number': '', // TODO: Lấy số điện thoại từ input nếu có
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          // Widget Form để quản lý các TextFormField và validation
          key: _formKey, // Gán GlobalKey cho Form
          child: Column(
            crossAxisAlignment:
                CrossAxisAlignment.stretch, // Các mục con chiếm hết chiều rộng
            children: [
              // --- Trường Email ---
              TextFormField(
                controller: _emailController,
                keyboardType:
                    TextInputType.emailAddress, // Bàn phím tối ưu cho email
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (value != _passwordController.text) {
                    // Kiểm tra khớp với mật khẩu đã nhập
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  padding:
                      const EdgeInsets.symmetric(vertical: 16.0), // Padding dọc
