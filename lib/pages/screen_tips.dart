          ...
          child: Stack(
            children: [
              CustomScrollView(
                ...
                slivers: [SliverToBoxAdapter(child: _buildCardAnimal(context))],
              ),
              _buildIconBack(),
            ],
          ),
  ...
  Widget _buildCardAnimal(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height: 150,
          child: Image.asset(OneImages.ar_tip, fit: BoxFit.contain),
        ),
        Container(
          padding: const EdgeInsets.all(10),
          decoration: BoxDecoration(
            image: const DecorationImage(
              image: AssetImage(OneImages.ar_back_tip),
              fit: BoxFit.fill,
            ),
