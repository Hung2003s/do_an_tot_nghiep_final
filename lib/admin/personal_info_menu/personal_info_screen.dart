        ...
        children: [
          ...
          Container(
            padding: const EdgeInsets.only(
                top: 40.0, bottom: 20.0, left: 16.0, right: 16.0), // Padding
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    const Expanded(
                      // Để tiêu đề chiếm không gian còn lại và có thể căn giữa
                      child: Center(
                        child: Text(
                          'Cài đặt',
                          style: TextStyle(
                    ...
                    const SizedBox(
                        width: 48.0), // Khoảng trống để cân bằng với nút back
                  ],
                ),
          ...
          Expanded(
            // Danh sách chiếm hết không gian còn lại và có thể cuộn
            child: SingleChildScrollView(
              // Sử dụng SingleChildScrollView cho danh sách
              padding: const EdgeInsets.all(16.0), // Padding cho danh sách
              child: Column(
                // Sử dụng Column để xếp các MenuListItem
                children: [
                  MenuListItem(
                    // Thông tin cá nhân
                    icon: Icons.panorama,
                  ...
                  MenuListItem(
                    ...
                    rightWidget: const Text('29K',
                        style: TextStyle(
                            fontSize: 16.0, color: Colors.grey)), // Giá trị
                    onTap: () {
